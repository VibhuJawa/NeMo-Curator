...
//!
//! Provides macros for function registration and argument parsing.

use proc_macro::TokenStream;
use quote::{format_ident, quote};
use syn::{parse_macro_input, Data, DeriveInput, Fields, ItemFn};

/// Derive macro for creating a FromHashMap implementation.
///
/// This allows initializing a struct from a HashMap<String, PyAny>.
...
/// Attribute macro for registering annotation functions.
///
/// This macro registers a function in the FN_REGISTRY and INPUT_TYPE_REGISTRY
/// so it can be called dynamically by name.
