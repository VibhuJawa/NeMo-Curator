...
def create_html_parser_judge(
    model_name: str, *, model_configs: list[Any] | None = None, model_providers: list[Any] | None = None,
    ...
    return PairwiseLLMJudgeStage(
        model_name=model_name, model_configs=model_configs, model_providers=model_providers,
        left_field="text", right_field="justext_extracted_text", left_label="MinerU-HTML", right_label="jusText",
        context_fields=("url",), criteria=HTML_PARSER_CRITERIA, output_prefix="html_parser_judge",
