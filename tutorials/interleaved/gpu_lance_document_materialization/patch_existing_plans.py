...
"""Replay durable coordinate plans through the checkpointed patch phase."""
...
from nemo_curator.stages.interleaved import LanceCoordinatePayloadPatchStage, LanceCoordinatePlanReader
...
def main() -> int:
    args = _parse_args()
    pipeline = Pipeline(
        name="gpu-lance-document-patch-replay",
        stages=[
