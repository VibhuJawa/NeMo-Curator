...
@dataclass
class InterleavedLanceWriterStage(BaseInterleavedWriter):
    """Write interleaved rows to Lance format with optional binary materialization."""

    file_extension: str = "lance"
    name: str = "interleaved_lance_writer"
