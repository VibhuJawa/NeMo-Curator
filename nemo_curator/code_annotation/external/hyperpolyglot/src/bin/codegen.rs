...
fn main() {
    ...
    println!("write_language_list");
    write_language_list(&languages);
    println!("write_language_info");
    write_language_info(&languages);
    println!("create_filename_map");
    create_filename_map(&languages);
    println!("create_interpreter_map");
    create_interpreter_map(&languages);
    println!("create_extension_map");
    create_extension_map(&languages);

    println!("create_disambiguation_heuristics_map");
